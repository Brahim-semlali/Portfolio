export const translations = {
  fr: {
    ...
    home: {
      ...
      recruiterPoint1Title: "Du frontend à l'API",
      recruiterPoint1Text: "Je construis des interfaces React et des API REST sécurisées avec une vision complète du produit.",
      recruiterPoint2Title: "Des données bien maîtrisées",
      recruiterPoint2Text: "Je conçois des modèles fiables et travaille avec PostgreSQL, PostGIS et les systèmes de permissions.",
      recruiterPoint3Title: "Prêt pour la livraison",
      recruiterPoint3Text: "Je connais les pratiques Git, Docker, Swagger et CI/CD qui rendent une application plus simple à livrer.",
    },
    about: {
      tag: "Profil",
      title: "Qui suis-",
  ...
  en: {
    ...
    home: {
      ...
      recruiterPoint1Title: "From frontend to API",
      recruiterPoint1Text: "I build React interfaces and secure REST APIs with an end-to-end product mindset.",
      recruiterPoint2Title: "Reliable data foundations",
      recruiterPoint2Text: "I design dependable models and work with PostgreSQL, PostGIS and permission systems.",
      recruiterPoint3Title: "Ready to ship",
      recruiterPoint3Text: "I use Git, Docker, Swagger and CI/CD practices that make applications easier to deliver.",
    },
    about: {
      tag: "Profile",
      title: "Who am ",
